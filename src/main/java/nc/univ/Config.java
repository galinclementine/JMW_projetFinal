...
@ComponentScan(basePackages = { "nc.univ.dao" })
@EnableJpaRepositories(basePackages = { "nc.univ.dao" }) // active les repositories
public class Config {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "nc.univ.model" });
